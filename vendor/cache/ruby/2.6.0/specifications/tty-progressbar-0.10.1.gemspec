# -*- encoding: utf-8 -*-
# stub: tty-progressbar 0.10.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.date = "2016-12-26"
  s.description = "A flexible progress bars drawing in terminal emulators.".freeze
  s.email = ["".freeze]
  s.homepage = "https://piotrmurach.github.io/tty/".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "3.1.2".freeze
  s.summary = "A flexible progress bars drawing in terminal emulators.".freeze
